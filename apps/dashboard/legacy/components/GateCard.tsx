import type { Gate, Flight, PassengerComputed, GateStats } from "../../src/types/types";
import { fmtTime } from "../../src/services/utils";
...
/**
 * Legacy gate detail panel.
 *
 * This used to show selected-gate details and related passengers in the map sidebar.
 * The current dashboard sidebar is passenger-focused, so this component is not wired in.
 */
          ...
          .map((p) => (
            ...
            >
              ...
              <span className="small">
                {p.activity === "moving" ? "在路上" : p.activity === "shopping" ? "购物" : p.activity === "dining" ? "餐饮" : p.activity === "lounge" ? "休息室" : p.activity === "idle" ? "停留" : p.activity === "at_gate" ? "已到口" : "已登机"}
              </span>
            </button>
          ))}
